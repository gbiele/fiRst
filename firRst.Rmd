...
* `VGAM` allows doing regression with more unusual responsemodels, like for example the beta binomial distribution.
...
One can also install multiple packages simulataneously as follows.
```{r, eval=FALSE}
